...
def diff_sparse0bins(colmap_a, colmap_b):
   ...
   # check points
    ...
    if num_points_a != num_points_b:
        print(f"⚠️ {colmap_num}: space 3D points: {num_points_a} vs {num_points_b} - {percentage_diff:.2f}% difference")
...
if __name__ == "__main__":
    ...
    if check_immersive_undist:
        ...
        assert filecmp.cmp(base_dir_a / 'camera_0001.npy',
                           base_dir_b / 'camera_0001.npy' ),'camera_0001.npy differs'
        assert filecmp.cmp(base_dir_a / 'colmap_0/images/camera_0001.png',
